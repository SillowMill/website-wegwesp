...
const CONFIG = {
  // Business identity
  name: "Weg-Wesp",
  tagline: "Wespenverdelging met 100% garantie.",
  logoUrl: "/logo.png",
  logoAlt: "Weg-Wesp Logo",
  logoClassName: "h-8 md:h-10",

  // Contact
  phone: "0496 78 49 48",
  phoneLink: "tel:+32496784948",
  email: "info@weg-wesp.be",
  whatsapp: "https://api.whatsapp.com/send?phone=32496784948",

  // Location
  address: "Vogelpers 85, 1500 Halle",
  region: "regio Halle en Pajottenland",
  ...
  // About text
  aboutText: "Weg-Wesp biedt professionele wespenverdelging in de regio Halle en het Pajottenland. Wij trachten binnen 48 uur na aanvraag te verdelgen met 100% garantie — indien niet succesvol, komen wij gratis terug. Betaling via Payconiq of cash.",
